            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        <label for="short_des" class="control-label mb-1"> Short Desc</label>
                        <textarea id="short_des" name="short_des" type="text" class="form-control" aria-required="true" aria-invalid="false" required>{{$short_des}}</textarea>
                     </div>
                     <div class="form-group">
