...
<head>
    ...
    <link href="{{asset('https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesom.min.css')}}" rel="stylesheet" media="all">
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('product_review_select')">
                            <a class="" href="{{url('/admin/product_review')}}">
